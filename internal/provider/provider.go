...
import (
	...
	"github.com/microsoft/terraform-provider-fabric/internal/services/onelakedas"
...
func (p *FabricProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		onelakedas.NewResourceOneLakeDataAccessSecurity,
...
func (p *FabricProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		onelakedas.NewDataSourceOneLakeDataAccessSecurity,
		onelakedas.NewDataSourceOneLakeDataAccessSecurities,

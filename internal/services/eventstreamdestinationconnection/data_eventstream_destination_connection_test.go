...
func TestUnit_EventstreamDestinationConnectionDataSource(t *testing.T) {
...
func TestAcc_EventstreamDestinationConnectionDataSource(t *testing.T) {
	...
	resource.ParallelTest(t, testhelp.NewTestAccCase(t, nil, nil, []resource.TestStep{
		// read by destination id - not found
		{
			Config: at.CompileConfig(
				testDataSourceItemHeader,
				map[string]any{
		...
		// read by id
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				resource.TestCheckResourceAttr(testDataSourceItemFQN, "destination_id", destinationID),

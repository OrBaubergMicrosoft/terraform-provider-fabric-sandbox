...
func TestUnit_AnomalyDetectorResource_Attributes(t *testing.T) {
...
func TestUnit_AnomalyDetectorResource_ImportState(t *testing.T) {
...
func TestUnit_AnomalyDetectorResource_CRUD(t *testing.T) {
	workspaceID := testhelp.RandomUUID()
